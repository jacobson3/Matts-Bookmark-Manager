...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="globals" Type="Folder">
			<Item Name="BMark_User Visible Strings.vi" Type="VI" URL="../globals/BMark_User Visible Strings.vi"/>
		</Item>
		<Item Name="support" Type="Folder">
			<Item Name="Message Queue" Type="Folder">
				<Item Name="BMark_Message Queue.lvlib" Type="Library" URL="../support/Message Queue/BMark_Message Queue.lvlib"/>
			</Item>
			<Item Name="User Event - Stop" Type="Folder">
				<Item Name="BMark_User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/BMark_User Event - Stop.lvlib"/>
			</Item>
